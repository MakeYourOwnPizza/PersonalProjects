...
# for mac
source_path="/Users/zhou/Documents/iCouldPhotos/test/"
dest_path="/Users/zhou/Documents/PhotosforMoments2/"
#dest_path="afp://192.168.86.46/home/Drive/Moments/Web/"
...
for files in names:
    ...
    for ptype in photo_type:
        pref = 'IMG_'
        if ext.upper() == ptype and not os.path.exists(dest_path+'Photos/'+ptype[1][1:]+'/'+cdate+'/'+pref+files):
